...
RUN_DEBIAN_STRETCH64_PKG = 1       # same using dpkg
...
known_weehosts = {
    ...
    "stretch64pkg" => { :ip => "192.168.33.24", :port => 8824, :mem => 512, :box => "debian/stretch64", :setup => "setup-buntu.sh",  :provisioner => "provision.sh"  },
  ...
  weehosts.each_with_index do |(hostname, info), index|
    ...
    config.vm.define hostname do |cfg|
      cfg.vm.provider :virtualbox do |vb, override|
        ...
        override.vm.network "forwarded_port", guest: 50222, host: 50222
